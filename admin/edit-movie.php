<?php
    ...
    $movie=$moviecontroller->getMovies($_GET['id']);
    if (($_SERVER['REQUEST_METHOD'] == 'POST')){
        //$moviecontroller->editMovie($_GET['id']);
     ...
     <div class ="col-sm-12" style="padding-left:0px;padding-right:0px;">
        ...
        <div class="col-sm-12">
            ...
            <div id="add-movie-form-container">
                <form class="form-horizontal" method="post" id="add-movie-form" action='add-movie.php?action=add' autocomplete="off" enctype="multipart/form-data" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            ?>
                            <select data-placeholder="Select Genre(s)..." multiple class="form-control genre" nam="submit">
                    ...
                    <div class="form-group">
                        ...
                        <img src="../<?=$movie[0]['img_path']?>" width="190" height="250" alt="" style="margin-bottom:15px">
                        <div class="col-sm-10">
